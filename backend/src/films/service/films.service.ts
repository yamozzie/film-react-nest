...
export class FilmsService {
    ...
    async takeSeat(filmId: string, scheduleId: string, seatKey: string): Promise<boolean> {
      return this.filmsRepository.updateScheduleSeats(filmId, scheduleId, seatKey)
    }
}